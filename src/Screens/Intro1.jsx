...
const Intro1 = () => {
    return (
        <View style={{ flex: 1 }}>
            <ImageBackground
                source={require('../Assets/Images/Backgroud_Intro1.png')} // Đường dẫn tới hình ảnh bạn muốn làm background
                style={styles.backgroundImage} // Style cho background
            >
                <View style={styles.textContainer}>
                    <Text style={styles.text}>Start your journey to a magical wedding experience</Text>
