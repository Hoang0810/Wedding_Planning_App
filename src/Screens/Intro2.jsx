...
const Intro2 = () => {
    return (
        <View style={{ flex: 1 }}>
            <ImageBackground
                source={require('../Assets/Images/Backgroud_Intro2.png')} // Đường dẫn tới hình ảnh bạn muốn làm background
                style={styles.backgroundImage} // Style cho background
            >
                <View style={styles.textContainer}>
                    <Text style={styles.text}>Discover the beauty that awaits on your special day.</Text>
